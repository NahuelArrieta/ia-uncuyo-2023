...
def iterate_hc(board, max_iterations):
    ...
    file = open("./tp5-busquedas-locales/results/hill_climbing.csv", "a")
...
def iterate_sa(board, max_iterations):
    ...
    file = open("./tp5-busquedas-locales/results/simulated_annealing.csv", "a")
    file.write("iterations,time\n")
    for _ in range(iterations_per_algo):
...
def iterate_ga(board, max_iterations):
    ...
    file = open("./tp5-busquedas-locales/results/genetic_algorithm.csv", "a")
    file.write("iterations,time\n")
    for _ in range(iterations_per_algo):
...
# max_iterations = [500,1000,2000,2000,2500]
